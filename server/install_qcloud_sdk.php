...
require_once './qcloud_config.php';
...
$secretKey = 'lNrAJLDznUzIRQDsIanaAapsjOskyJh0';
$userid = '2347632';
YoutuConf::setAppInfo($appid, $secretId, $secretKey, $userid, YoutuConf::API_YOUTU_END_POINT );
